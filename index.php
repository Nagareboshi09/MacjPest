...
<head>
    ...
    <link rel="stylesheet" href="Admin Side/css/modern-dashboard.css">
    <link rel="stylesheet" href="Admin Side/css/modern-modal.css">
   ...
   <header class="header">
        ...
        <div class="user-menu">
            ...
            <div class="user-info">
                ...
                <div>
                    <div class="user-name"><?php echo htmlspecialchars($_SESSION['username'] ?? 'Admin', ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8'); ?></div>
    ...
    <div class="container">
        ...
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                <ul>
                    <li class="active"><a href="index.php"><i class="fas fa-chart-line"></i> Dashboard</a></li>
                    <li><a href="Admin Side/profile.php"><i class="fas fa-user-circle"></i> My Profile</a></li>
                    <li><a href="Admin Side/chemical_inventory.php"><i class="fas fa-flask"></i> Chemical Inventory</a></li>
                    <li><a href="Admin Side/services.php"><i class="fas fa-concierge-bell"></i> Services</a></li>
                    <li><a href="Admin Side/clients.php"><i class="fas fa-users"></i> Clients</a></li>
                    <li><a href="Admin Side/SignOut.php"><i class="fas fa-sign-out-alt"></i> Logout</a></li>
                </ul>
            </nav>
        </aside>
                    ...
                    <div class="dashboard-card">
                        ...
                        <div class="card-body">
                            ...
                            <?php else: ?>
                                ...
                                <div class="view-all">
                                    <a href="Admin Side/chemical_inventory.php">View All Low Stock Chemicals <i class="fas fa-chevron-right"></i></a>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="dashboard-card">
                        ...
                        <div class="card-body">
                            ...
                            <?php else: ?>
                                ...
                                <div class="view-all">
                                    <a href="Admin Side/chemical_inventory.php">View All Chemicals <i class="fas fa-chevron-right"></i></a>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
